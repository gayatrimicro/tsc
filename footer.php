...
<div class="footer-header__background">
  <div class="container">
    <ul class="footer-header ">
      <li class="footer-header__item  footer-header__item--104">
        <a href="http://texasspecialtyclinic.com/about-us/">About Us</a>
      </li>
      ...
      <div class="footer__block flexComponent flexComponent--row footer__block--right">
        <div class="footer__signup">
          ...
          <p class="footer__signupText">
            ...
            </br> Phone: <a href="tel:(888) 871-1883" style="color: #464646">(888) 871-1883</a>
            <br> Fax: (888) 900-4530
          </p>
...
<div class="company-footer">
  <div class="container company-footer__container">
    <ul class="company-footer__list" style="width: 100%;">
      <li class="company-footer__listItem">Web designed by <a href="https://ibridgedigital.com/" target="_blank" class="company-footer__listLink">iBridge Digital</a>
      </li>
    </ul>
  </div>
</div>
